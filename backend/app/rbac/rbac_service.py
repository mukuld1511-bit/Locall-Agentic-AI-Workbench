...
PERMISSIONS_CATALOGUE = [
    ...
    {"id": "FILE_READ_WORKSPACE", "name": "Read Workspace Files", "risk": "LOW", "desc": "Inspect code, configurations, and logs in workspace"},
    ...
    {"id": "FILE_WRITE_WORKSPACE", "name": "Modify Workspace Files", "risk": "MEDIUM", "desc": "Edit and save scripts and workspace files"},
    {"id": "FILE_CREATE_WORKSPACE", "name": "Create Workspace Files", "risk": "MEDIUM", "desc": "Create new files and directories in workspace"},
    {"id": "TERMINAL_EXECUTE", "name": "Execute Safe Terminal Commands", "risk": "MEDIUM", "desc": "Run controlled development and diagnostic commands"},
    {"id": "DB_EXECUTE_QUERY", "name": "Execute SQL Queries on Database", "risk": "MEDIUM", "desc": "Run analytical SELECT queries on presentation DB"},
    
    # High-Risk Permissions
    {"id": "FILE_DELETE_WORKSPACE", "name": "Delete Workspace Files", "risk": "HIGH", "desc": "Permanently delete files or directories in workspace"},
